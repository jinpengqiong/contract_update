...
import {AlreadyInitialized, InvalidValue, Unauthorized} from "../shared/Errors.sol";

/**
 * @title TransparentLogicV1
 * @notice First version of logic contract that works behind TransparentProxy
 */
contract TransparentLogicV1 is BaseStorage {
